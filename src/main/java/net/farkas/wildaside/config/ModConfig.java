...
public class ModConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> GLOWING_HICKORY_FOREST_WEIGHT = BUILDER
            .comment("Spawn weight of the Glowing Hickory Forest biome (def: 1)")
            .define("glowing_hickory_forest_weight", 1);
    public static final ForgeConfigSpec.ConfigValue<Integer> VIBRION_HIVE_WEIGHT = BUILDER
