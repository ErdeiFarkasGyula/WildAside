...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> MUCELLITH_AMBIENT = registerSoundEvent("entity.mucellith.ambient");
    public static final RegistryObject<SoundEvent> MUCELLITH_HURT = registerSoundEvent("entity.mucellith.hurt");
    public static final RegistryObject<SoundEvent> MUCELLITH_DEATH = registerSoundEvent("entity.mucellith.death");
