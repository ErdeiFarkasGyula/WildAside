...
public class BrownlikeSubstiliumMushroomFeature extends AbstractHugeMushroomFeature {
    public BrownlikeSubstiliumMushroomFeature(Codec<HugeMushroomFeatureConfiguration> pCodec) {
        super(pCodec);
    }

    @Override
    protected int getTreeHeight(RandomSource pRandom) {
        return pRandom.nextInt(6, 14);
    }
